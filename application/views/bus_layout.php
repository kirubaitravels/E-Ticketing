                ...
                <!-- Modal -->
                <!--  48 Seater Capacity -->
                <div class="modal fade" id="BusStructure48" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content" style = "width:60em;margin-left:-30px">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Schedule Booking Status</h4>
                      </div>
                      ...
                      <div class="modal-body" style = "height:30em;width:100%">
                        ...
                        <div class = "col-md-8" style ="background-color:;border-radius:5px;margin-left:5px;margin-top:20px;color:Green;padding-top:20px;height:25em;width:80%">
                           ...
                           <?php //$form= array('id' =>'form_det','onSubmit'=>'return checkseats()'); ?>
                               ...
                               <?php //$form1= array('schedule_id'=>$my_schedule->schedule_id); ?>
                            <div id="my_bus_structure">
...
<!--                                  <div id="error_div">
                ...
                <!-- Modal -->
                <!--  52 Seater Capacity -->
                <div class="modal fade" id="BusStructure52" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content" style = "width:60em;margin-left:-30px">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
