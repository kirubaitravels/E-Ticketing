            ...
            <div class="page-content">
                ...
                <div class="banner-container">
                    <div class="banner" style="height:25em">
                    	<div class="carousel_container">
							<div class="carousel-inner">
				                <div class="item active"> 
				                    <img src="<?php echo base_url();?>images/promotionsBanner.png" style="height:550px;width:100%;" alt="First slide" style="height:100%;width:100%"> 
				               ...
				               <td style="background: rgb(230, 230, 230);border:#ccc 0px solid;padding:0em 0em 0em 0em;height:14px">
								 ...
								 <div id="error_div">
								  ...
								  <div class="submit_booking">
								   	 	<input class = "btn btn-primary" type="submit" value="Submit" id="submit_seat" onclick="checkseats()"/>
								   	 	<?php echo form_close();?>
						          </div >
