...
$reference = $the_company;//unique order id of the transaction, generated by merchant
$first_name =$name;
// $last_name = "Dan";
$email = $email;
...
?> 
<iframe src="<?php echo $iframe_src;?>" width="80%" height="700px"  scrolling="no" frameBorder="0" style="margin-left:1em" position="absolute">
